...
export default function AIInsights() {
  ...
  const [insights, setInsights] = useState<InsightData[]>([]); // State for array of AI insights
  const [lastUpdated, setLastUpdated] = useState<Date | null>(null); // State for last updated date
      ...
      setInsights([
        {
          ...
          message: "Working to restore AI insights. Please check back soon.",
        ...
        prev.map((a) =>
          a.insightId === insight.id
            ? {
                ...a,
                answer:
                  "Sorry, unable to generate a detailed answer. Please try again.",
                isLoading: false,
              }
            : a
        )
