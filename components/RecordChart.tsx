...
export default async function RecordChart() {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-100/50 dark:border-gray-700/50 hover:shadow-2xl">
      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-50 via-green-500 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
      ...
      (!records || records.length === 0) ? (
        <div className="text-center py-6 sm:py-8">
          ...
          <h4 className="text-base sm:text-lg font-bold text-gray-800 dark:text-gray-300 mb-2">
            No Data to Display
          </h4>
